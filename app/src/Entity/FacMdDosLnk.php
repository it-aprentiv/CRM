 ...
 * 3FacMdDosLnk
 *
 * @ORM\Table(name="3_fac_md_dos_lnk")
 * @ORM\Entity
 */
class FacMdDosLnk
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="id_dos", type="integer", nullable=true)
     */
    private $idDos;
     ...
     * @var int|null
     *
     * @ORM\Column(name="idb_dos", type="integer", nullable=true)
     */
    private $idbDos;
     ...
     * @var float|null
     *
     * @ORM\Column(name="prct_dossier", type="float", precision=10, scale=0, nullable=true)
     */
    private $prctDossier;

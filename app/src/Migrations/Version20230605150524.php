 ...
 */
final class Version20230605150524 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE 1_formation_dossier ADD CONSTRAINT FK_EB25D8C8613FECDF FOREIGN KEY (session_id) REFERENCES sessions (id)');
        ...
        $this->addSql('ALTER TABLE sessions CHANGE formateur_formation_id formateur_formation_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE sessions ADD CONSTRAINT FK_9A609D138B564282 FOREIGN KEY (formateur_formation_id) REFERENCES 1_contact (id)');
        ...
        $this->addSql('ALTER TABLE thematiques_formations DROP FOREIGN KEY FK_237C0029155D8F51');
        $this->addSql('ALTER TABLE thematiques_formations CHANGE formateur_id formateur_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE thematiques_formations ADD CONSTRAINT FK_237C0029155D8F51 FOREIGN KEY (formateur_id) REFERENCES 1_contact (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sessions CHANGE formateur_formation_id formateur_formation_id INT NOT NULL');
        $this->addSql('ALTER TABLE stagiaire_formation_dossier DROP FOREIGN KEY FK_F69D28B1E3D54947');
        $this->addSql('ALTER TABLE thematiques_formations DROP FOREIGN KEY FK_237C0029155D8F51');
        $this->addSql('ALTER TABLE thematiques_formations CHANGE formateur_id formateur_id INT NOT NULL');
        $this->addSql('ALTER TABLE thematiques_formations ADD CONSTRAINT FK_237C0029155D8F51 FOREIGN KEY (formateur_id) REFERENCES 1_formateur_formation (id)');

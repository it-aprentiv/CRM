...
// Returns the private 'App\Repository\OpcaNoteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/OpcaNoteRepository.php';

return $this->privates['App\\Repository\\OpcaNoteRepository'] = new \App\Repository\OpcaNoteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\CollaborateurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CollaborateurRepository.php';

return $this->privates['App\\Repository\\CollaborateurRepository'] = new \App\Repository\CollaborateurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\CiviliteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CiviliteRepository.php';

return $this->privates['App\\Repository\\CiviliteRepository'] = new \App\Repository\CiviliteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

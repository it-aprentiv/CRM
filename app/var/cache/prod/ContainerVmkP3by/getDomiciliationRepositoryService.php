...
// Returns the private 'App\Repository\DomiciliationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DomiciliationRepository.php';

return $this->privates['App\\Repository\\DomiciliationRepository'] = new \App\Repository\DomiciliationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

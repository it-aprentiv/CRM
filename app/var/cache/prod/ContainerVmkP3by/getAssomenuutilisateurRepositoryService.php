...
// Returns the private 'App\Repository\AssomenuutilisateurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AssomenuutilisateurRepository.php';

return $this->privates['App\\Repository\\AssomenuutilisateurRepository'] = new \App\Repository\AssomenuutilisateurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

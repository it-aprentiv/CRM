...
// Returns the private 'App\Repository\FactureDomiciliationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FactureDomiciliationRepository.php';

return $this->privates['App\\Repository\\FactureDomiciliationRepository'] = new \App\Repository\FactureDomiciliationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

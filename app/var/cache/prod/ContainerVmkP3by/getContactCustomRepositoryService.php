...
// Returns the private 'App\Repository\ContactCustomRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContactCustomRepository.php';

return $this->privates['App\\Repository\\ContactCustomRepository'] = new \App\Repository\ContactCustomRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

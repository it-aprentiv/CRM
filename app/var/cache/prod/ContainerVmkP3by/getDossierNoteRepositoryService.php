...
// Returns the private 'App\Repository\DossierNoteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DossierNoteRepository.php';

return $this->privates['App\\Repository\\DossierNoteRepository'] = new \App\Repository\DossierNoteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

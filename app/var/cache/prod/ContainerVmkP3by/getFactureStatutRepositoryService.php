...
// Returns the private 'App\Repository\FactureStatutRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FactureStatutRepository.php';

return $this->privates['App\\Repository\\FactureStatutRepository'] = new \App\Repository\FactureStatutRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\FormationDossierStagiaireDossierRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FormationDossierStagiaireDossierRepository.php';

return $this->privates['App\\Repository\\FormationDossierStagiaireDossierRepository'] = new \App\Repository\FormationDossierStagiaireDossierRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

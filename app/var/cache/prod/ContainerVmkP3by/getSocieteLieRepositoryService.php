...
// Returns the private 'App\Repository\SocieteLieRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SocieteLieRepository.php';

return $this->privates['App\\Repository\\SocieteLieRepository'] = new \App\Repository\SocieteLieRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

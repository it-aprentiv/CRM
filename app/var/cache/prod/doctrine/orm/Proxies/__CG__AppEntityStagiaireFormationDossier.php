 ...
 */
class StagiaireFormationDossier extends \App\Entity\StagiaireFormationDossier implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\StagiaireFormationDossier' . "\0" . 'formationdossierstagiaire', '' . "\0" . 'App\\Entity\\StagiaireFormationDossier' . "\0" . 'nomTable'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StagiaireFormationDossier $proxy) {
    ...
    public function getFormationdossierstagiaire()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFormationdossierstagiaire', []);

        return parent::getFormationdossierstagiaire();
    }
    ...
    public function setFormationdossierstagiaire($formationdossierstagiaire)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFormationdossierstagiaire', [$formationdossierstagiaire]);

        return parent::setFormationdossierstagiaire($formationdossierstagiaire);
    }

 ...
 */
class FactureStatut extends \App\Entity\FactureStatut implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\FactureStatut' . "\0" . 'id', '' . "\0" . 'App\\Entity\\FactureStatut' . "\0" . 'idb', '' . "\0" . 'App\\Entity\\FactureStatut' . "\0" . 'statut', '' . "\0" . 'App\\Entity\\FactureStatut' . "\0" . 'dateAdd', '' . "\0" . 'App\\Entity\\FactureStatut' . "\0" . 'dateMaj', '' . "\0" . 'App\\Entity\\FactureStatut' . "\0" . 'idUserAdd', '' . "\0" . 'App\\Entity\\FactureStatut' . "\0" . 'idUserMaj', '' . "\0" . 'App\\Entity\\FactureStatut' . "\0" . 'statutRst'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FactureStatut $proxy) {

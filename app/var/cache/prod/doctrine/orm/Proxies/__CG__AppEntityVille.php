...
class Ville extends \App\Entity\Ville implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'idb', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'idPays', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'idbPays', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'codePostal', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'nomVille', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'idRegion', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'idbRegion', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'dateAdd', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'idUserAdd', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'dateMaj', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'idUserMaj', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'statutRst', '' . "\0" . 'App\\Entity\\Ville' . "\0" . 'cp'];
        }

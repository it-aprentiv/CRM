 ...
 */
class FormationCatalogueNote extends \App\Entity\FormationCatalogueNote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\FormationCatalogueNote' . "\0" . 'formationCatalogue', 'texteNote', 'idbActionStatut', 'idUserAdd', 'note', 'idbAction', 'idb', 'idActionStatut', 'idUserMaj', 'dateMaj', 'idAction', 'idNomAction', 'rappelleur', 'deletedAt', 'idTable', 'dateAction', 'nomCon', 'idbTable', 'dateAdd', 'idUserAction', 'id', 'statutRst', 'idbNomAction'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormationCatalogueNote $proxy) {
    ...
    public function getFormationCatalogue()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFormationCatalogue', []);

        return parent::getFormationCatalogue();
    }

    /**
     * {@inheritDoc}
     */
    public function setFormationCatalogue(?\App\Entity\FormationCatalogue $formationCatalogue)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFormationCatalogue', [$formationCatalogue]);

        return parent::setFormationCatalogue($formationCatalogue);
    }

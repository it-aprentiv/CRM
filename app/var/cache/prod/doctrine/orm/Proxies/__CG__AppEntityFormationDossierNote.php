 ...
 */
class FormationDossierNote extends \App\Entity\FormationDossierNote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\FormationDossierNote' . "\0" . 'formationDossier', '' . "\0" . 'App\\Entity\\FormationDossierNote' . "\0" . 'nomTable', 'texteNote', 'idbActionStatut', 'idUserAdd', 'note', 'idbAction', 'idb', 'idActionStatut', 'idUserMaj', 'dateMaj', 'idAction', 'idNomAction', 'rappelleur', 'deletedAt', 'idTable', 'dateAction', 'nomCon', 'idbTable', 'dateAdd', 'idUserAction', 'id', 'statutRst', 'idbNomAction'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormationDossierNote $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setFormationDossier(?\App\Entity\FormationDossier $formationDossier)
    {
    ...
    public function setNomTable($nomTable)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomTable', [$nomTable]);

        return parent::setNomTable($nomTable);
    }

 ...
 */
class FormateurNote extends \App\Entity\FormateurNote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\FormateurNote' . "\0" . 'noteformateur', 'texteNote', 'idbActionStatut', 'idUserAdd', 'note', 'idbAction', 'idb', 'idActionStatut', 'idUserMaj', 'dateMaj', 'idAction', 'idNomAction', 'rappelleur', 'deletedAt', 'idTable', 'dateAction', 'nomCon', 'idbTable', 'dateAdd', 'idUserAction', 'id', 'statutRst', 'idbNomAction'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormateurNote $proxy) {
    ...
    public function getNoteformateur()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNoteformateur', []);

        return parent::getNoteformateur();
    }
    ...
    public function setNoteformateur($noteformateur): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNoteformateur', [$noteformateur]);

        parent::setNoteformateur($noteformateur);
    }

 ...
 */
class DocDossierNote extends \App\Entity\DocDossierNote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\DocDossierNote' . "\0" . 'formation', 'texteNote', 'idbActionStatut', 'idUserAdd', 'note', 'idbAction', 'idb', 'idActionStatut', 'idUserMaj', 'dateMaj', 'idAction', 'idNomAction', 'rappelleur', 'deletedAt', 'idTable', 'dateAction', 'nomCon', 'idbTable', 'dateAdd', 'idUserAction', 'id', 'statutRst', 'idbNomAction'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DocDossierNote $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getFormation(): ?\App\Entity\Dossier
    {
     ...
     * {@inheritDoc}
     */
    public function setFormation(?\App\Entity\Dossier $formation): \App\Entity\DossierNote
    {

 ...
 */
class FactureNote extends \App\Entity\FactureNote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\FactureNote' . "\0" . 'facture', 'texteNote', 'idbActionStatut', 'idUserAdd', 'note', 'idbAction', 'idb', 'idActionStatut', 'idUserMaj', 'dateMaj', 'idAction', 'idNomAction', 'rappelleur', 'deletedAt', 'idTable', 'dateAction', 'nomCon', 'idbTable', 'dateAdd', 'idUserAction', 'id', 'statutRst', 'idbNomAction'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FactureNote $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setFacture(?\App\Entity\Facture $facture): \App\Entity\FactureNote
    {

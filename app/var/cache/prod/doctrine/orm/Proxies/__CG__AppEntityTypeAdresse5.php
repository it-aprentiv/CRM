 ...
 */
class TypeAdresse5 extends \App\Entity\TypeAdresse5 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\TypeAdresse5' . "\0" . 'id', '' . "\0" . 'App\\Entity\\TypeAdresse5' . "\0" . 'idb', '' . "\0" . 'App\\Entity\\TypeAdresse5' . "\0" . 'typeAdresse'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeAdresse5 $proxy) {

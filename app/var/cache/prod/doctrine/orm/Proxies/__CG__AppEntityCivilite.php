 ...
 */
class Civilite extends \App\Entity\Civilite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Civilite' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Civilite' . "\0" . 'idb', '' . "\0" . 'App\\Entity\\Civilite' . "\0" . 'civilite'];
        }

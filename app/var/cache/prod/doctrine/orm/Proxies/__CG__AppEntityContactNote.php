 ...
 */
class ContactNote extends \App\Entity\ContactNote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContactNote $proxy) {
    ...
    public function setIdTableContact($idTableContact): void
    {
        ...
        parent::setIdTableContact($idTableContact);
    }

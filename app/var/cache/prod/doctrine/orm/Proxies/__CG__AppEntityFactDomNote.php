 ...
 */
class FactDomNote extends \App\Entity\FactDomNote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\FactDomNote' . "\0" . 'factureDom', 'texteNote', 'idbActionStatut', 'idUserAdd', 'note', 'idbAction', 'idb', 'idActionStatut', 'idUserMaj', 'dateMaj', 'idAction', 'idNomAction', 'rappelleur', 'deletedAt', 'idTable', 'dateAction', 'nomCon', 'idbTable', 'dateAdd', 'idUserAction', 'id', 'statutRst', 'idbNomAction'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FactDomNote $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getFactureDom(): ?\App\Entity\FactureDomiciliation
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFactureDom', []);

        return parent::getFactureDom();
    }

    /**
     * {@inheritDoc}
     */
    public function setFactureDom(\App\Entity\FactureDomiciliation $factureDom): \App\Entity\FactDomNote
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFactureDom', [$factureDom]);

        return parent::setFactureDom($factureDom);
    }

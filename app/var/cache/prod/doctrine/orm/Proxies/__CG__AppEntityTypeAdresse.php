 ...
 */
class TypeAdresse extends \App\Entity\TypeAdresse implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\TypeAdresse' . "\0" . 'idTypeAdresse', '' . "\0" . 'App\\Entity\\TypeAdresse' . "\0" . 'typeAdresse'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeAdresse $proxy) {

...
// Returns the private 'App\Repository\ContactNoteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContactNoteRepository.php';

return $this->privates['App\\Repository\\ContactNoteRepository'] = new \App\Repository\ContactNoteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

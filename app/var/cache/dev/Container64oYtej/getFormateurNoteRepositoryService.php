...
// Returns the private 'App\Repository\FormateurNoteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FormateurNoteRepository.php';

return $this->privates['App\\Repository\\FormateurNoteRepository'] = new \App\Repository\FormateurNoteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\EncaissementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EncaissementRepository.php';

return $this->privates['App\\Repository\\EncaissementRepository'] = new \App\Repository\EncaissementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

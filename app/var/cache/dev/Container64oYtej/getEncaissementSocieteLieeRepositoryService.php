...
// Returns the private 'App\Repository\EncaissementSocieteLieeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EncaissementSocieteLieeRepository.php';

return $this->privates['App\\Repository\\EncaissementSocieteLieeRepository'] = new \App\Repository\EncaissementSocieteLieeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

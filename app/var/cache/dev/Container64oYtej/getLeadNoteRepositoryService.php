...
// Returns the private 'App\Repository\LeadNoteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LeadNoteRepository.php';

return $this->privates['App\\Repository\\LeadNoteRepository'] = new \App\Repository\LeadNoteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

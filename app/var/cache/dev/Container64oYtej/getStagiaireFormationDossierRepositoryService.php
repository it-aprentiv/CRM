...
// Returns the private 'App\Repository\StagiaireFormationDossierRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/StagiaireFormationDossierRepository.php';

return $this->privates['App\\Repository\\StagiaireFormationDossierRepository'] = new \App\Repository\StagiaireFormationDossierRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\TypedomRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TypedomRepository.php';

return $this->privates['App\\Repository\\TypedomRepository'] = new \App\Repository\TypedomRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

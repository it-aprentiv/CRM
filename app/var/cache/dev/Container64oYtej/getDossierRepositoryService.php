...
// Returns the private 'App\Repository\DossierRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DossierRepository.php';

return $this->privates['App\\Repository\\DossierRepository'] = new \App\Repository\DossierRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

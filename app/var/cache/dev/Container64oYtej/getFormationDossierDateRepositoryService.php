...
// Returns the private 'App\Repository\FormationDossierDateRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FormationDossierDateRepository.php';

return $this->privates['App\\Repository\\FormationDossierDateRepository'] = new \App\Repository\FormationDossierDateRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\FormationCatalogueRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FormationCatalogueRepository.php';

return $this->privates['App\\Repository\\FormationCatalogueRepository'] = new \App\Repository\FormationCatalogueRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

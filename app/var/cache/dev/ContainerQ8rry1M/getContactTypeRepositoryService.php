...
// Returns the private 'App\Repository\ContactTypeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContactTypeRepository.php';

return $this->privates['App\\Repository\\ContactTypeRepository'] = new \App\Repository\ContactTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\PropalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PropalRepository.php';

return $this->privates['App\\Repository\\PropalRepository'] = new \App\Repository\PropalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\CritFinOpcaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CritFinOpcaRepository.php';

return $this->privates['App\\Repository\\CritFinOpcaRepository'] = new \App\Repository\CritFinOpcaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

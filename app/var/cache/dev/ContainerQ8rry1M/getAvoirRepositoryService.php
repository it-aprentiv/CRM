...
// Returns the private 'App\Repository\AvoirRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AvoirRepository.php';

return $this->privates['App\\Repository\\AvoirRepository'] = new \App\Repository\AvoirRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

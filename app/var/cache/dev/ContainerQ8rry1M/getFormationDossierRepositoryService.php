...
// Returns the private 'App\Repository\FormationDossierRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FormationDossierRepository.php';

return $this->privates['App\\Repository\\FormationDossierRepository'] = new \App\Repository\FormationDossierRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

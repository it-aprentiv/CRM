...
// Returns the private 'App\Repository\NoteActionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/NoteActionRepository.php';

return $this->privates['App\\Repository\\NoteActionRepository'] = new \App\Repository\NoteActionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

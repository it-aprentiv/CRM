...
// Returns the private 'App\Repository\EncaissementNoteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EncaissementNoteRepository.php';

return $this->privates['App\\Repository\\EncaissementNoteRepository'] = new \App\Repository\EncaissementNoteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\FormationDossierStatutRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FormationDossierStatutRepository.php';

return $this->privates['App\\Repository\\FormationDossierStatutRepository'] = new \App\Repository\FormationDossierStatutRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\NoteNomTableRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/NoteNomTableRepository.php';

return $this->privates['App\\Repository\\NoteNomTableRepository'] = new \App\Repository\NoteNomTableRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\NoteActionStatutRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/NoteActionStatutRepository.php';

return $this->privates['App\\Repository\\NoteActionStatutRepository'] = new \App\Repository\NoteActionStatutRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

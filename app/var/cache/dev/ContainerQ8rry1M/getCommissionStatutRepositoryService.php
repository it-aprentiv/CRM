...
// Returns the private 'App\Repository\CommissionStatutRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CommissionStatutRepository.php';

return $this->privates['App\\Repository\\CommissionStatutRepository'] = new \App\Repository\CommissionStatutRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

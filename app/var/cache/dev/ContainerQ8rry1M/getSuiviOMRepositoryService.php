...
// Returns the private 'App\Repository\SuiviOMRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SuiviOMRepository.php';

return $this->privates['App\\Repository\\SuiviOMRepository'] = new \App\Repository\SuiviOMRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

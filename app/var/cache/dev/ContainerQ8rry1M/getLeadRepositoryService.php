...
// Returns the private 'App\Repository\LeadRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LeadRepository.php';

return $this->privates['App\\Repository\\LeadRepository'] = new \App\Repository\LeadRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

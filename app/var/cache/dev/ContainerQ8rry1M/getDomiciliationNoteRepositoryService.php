...
// Returns the private 'App\Repository\DomiciliationNoteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DomiciliationNoteRepository.php';

return $this->privates['App\\Repository\\DomiciliationNoteRepository'] = new \App\Repository\DomiciliationNoteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

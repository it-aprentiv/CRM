 ...
 */
class ContactAdresseType extends \App\Entity\ContactAdresseType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\ContactAdresseType' . "\0" . 'idTypeAdresse', '' . "\0" . 'App\\Entity\\ContactAdresseType' . "\0" . 'typeAdresse'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContactAdresseType $proxy) {
    ...
    public function getIdTypeAdresse(): int
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdTypeAdresse();
        }

 ...
 */
class DevisStatut extends \App\Entity\DevisStatut implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\DevisStatut' . "\0" . 'id', '' . "\0" . 'App\\Entity\\DevisStatut' . "\0" . 'idb', '' . "\0" . 'App\\Entity\\DevisStatut' . "\0" . 'statutDevis', '' . "\0" . 'App\\Entity\\DevisStatut' . "\0" . 'dateAdd', '' . "\0" . 'App\\Entity\\DevisStatut' . "\0" . 'dateMaj', '' . "\0" . 'App\\Entity\\DevisStatut' . "\0" . 'devisStatut', '' . "\0" . 'App\\Entity\\DevisStatut' . "\0" . 'idUserAdd', '' . "\0" . 'App\\Entity\\DevisStatut' . "\0" . 'idUserMaj', '' . "\0" . 'App\\Entity\\DevisStatut' . "\0" . 'statutRst'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DevisStatut $proxy) {
    ...
    public function setStatutDevis(?string $statutDevis): void
    {
        ...
        parent::setStatutDevis($statutDevis);
    }
    ...
    public function getDevisStatut(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDevisStatut', []);

        return parent::getDevisStatut();
    }
    ...
    public function setDevisStatut(?string $devisStatut): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDevisStatut', [$devisStatut]);

        parent::setDevisStatut($devisStatut);
    }

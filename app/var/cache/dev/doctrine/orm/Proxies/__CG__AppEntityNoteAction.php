 ...
 */
class NoteAction extends \App\Entity\NoteAction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\NoteAction' . "\0" . 'id', '' . "\0" . 'App\\Entity\\NoteAction' . "\0" . 'idb', '' . "\0" . 'App\\Entity\\NoteAction' . "\0" . 'nomAction', '' . "\0" . 'App\\Entity\\NoteAction' . "\0" . 'dateAdd', '' . "\0" . 'App\\Entity\\NoteAction' . "\0" . 'idUserAdd', '' . "\0" . 'App\\Entity\\NoteAction' . "\0" . 'dateMaj', '' . "\0" . 'App\\Entity\\NoteAction' . "\0" . 'idUserMaj', '' . "\0" . 'App\\Entity\\NoteAction' . "\0" . 'statutRst', '' . "\0" . 'App\\Entity\\NoteAction' . "\0" . 'action'];
        }

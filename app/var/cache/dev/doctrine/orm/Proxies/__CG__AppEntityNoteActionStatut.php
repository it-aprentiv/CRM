 ...
 */
class NoteActionStatut extends \App\Entity\NoteActionStatut implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\NoteActionStatut' . "\0" . 'actionStatut', '' . "\0" . 'App\\Entity\\NoteActionStatut' . "\0" . 'id', '' . "\0" . 'App\\Entity\\NoteActionStatut' . "\0" . 'idb', '' . "\0" . 'App\\Entity\\NoteActionStatut' . "\0" . 'dateAdd', '' . "\0" . 'App\\Entity\\NoteActionStatut' . "\0" . 'idUserAdd', '' . "\0" . 'App\\Entity\\NoteActionStatut' . "\0" . 'dateMaj', '' . "\0" . 'App\\Entity\\NoteActionStatut' . "\0" . 'idUserMaj', '' . "\0" . 'App\\Entity\\NoteActionStatut' . "\0" . 'statutRst'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NoteActionStatut $proxy) {
    ...
    public function getActionStatut(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getActionStatut', []);

        return parent::getActionStatut();
    }
    ...
    public function setActionStatut(?string $actionStatut): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setActionStatut', [$actionStatut]);

        parent::setActionStatut($actionStatut);
    }

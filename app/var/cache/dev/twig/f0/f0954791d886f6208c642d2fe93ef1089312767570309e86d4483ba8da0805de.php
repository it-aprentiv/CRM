...
class __TwigTemplate_56ecf41430d23abfd8d052cbeb7cf38f4ee69290330786930cf9667f8ca8345d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 17
        echo "            <li class=\"breadcrumb-item active\" aria-current=\"page\">Page introuvable</li>
        </ol>
    </nav>

    <h2 class=\"text-center mt-2 text-primary text-danger\">PAGE INTROUVABLE !</h2>
    <div class=\"row d-flex justify-content-center\">
        <div class=\"col-md-6\">
            <p class=\"alert alert-warning\">
                La page que vous voulez consulter n'existe pas ou a été déplacée !
            </p>
        </div>
    </div>
";
...
{% block title %}Oups - Erreur{% endblock %}
...
{% block body %}
    <nav aria-label=\"breadcrumb\">
        <ol class=\"breadcrumb\">
            ...
            {% endif %}
            <li class=\"breadcrumb-item active\" aria-current=\"page\">Page introuvable</li>
        </ol>
    </nav>
...
{% endblock %}
", "@Twig/Exception/error404.html.twig", "/home/jeremy/Bureau/project/app/templates/bundles/TwigBundle/Exception/error404.html.twig");
    }
}

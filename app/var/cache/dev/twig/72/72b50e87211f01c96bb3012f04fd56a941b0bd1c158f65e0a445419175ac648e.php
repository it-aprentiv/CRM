...
class __TwigTemplate_f3594135e4a9b33cd3c7121be98f936a244ff0444df5e11a937fc1fa3ceeda99 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
Personnes concernée(s) : ";
        // line 28
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["propal"]) || array_key_exists("propal", $context) ? $context["propal"] : (function () { throw new RuntimeError('Variable "propal" does not exist.', 28, $this->source); })()), "personnes", [], "any", false, false, false, 28), "html", null, true);
        echo "<br/></li><li>
...
Le prix de l’action est fixé à :  ";
        // line 30
        (((isset($context["propal"]) || array_key_exists("propal", $context) ? $context["propal"] : (function () { throw new RuntimeError('Variable "propal" does not exist.', 30, $this->source); })())) ? (print (twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["propal"]) || array_key_exists("propal", $context) ? $context["propal"] : (function () { throw new RuntimeError('Variable "propal" does not exist.', 30, $this->source); })()), "coutht", [], "any", false, false, false, 30), "html", null, true))) : (print ("")));
        echo " € HT.<br/>
...
";
    ...
    {
        return array (  118 => 40,  109 => 33,  106 => 32,  101 => 30,  96 => 28,  79 => 14,  74 => 13,  69 => 12,  58 => 11,  51 => 7,  43 => 1,);
    }
...
&#9679; Le règlement intérieur figure en annexe, vous voudrez bien le remettre au(x) stagiaire(s).</li><li>
<span style=\"font-family: Arial Black;font-size: 10px\">PARTICIPANTS :</span><br/>
Personnes concernée(s) : {{ propal.personnes }}<br/></li><li>
<span style=\"font-family: Arial Black;font-size: 10px\">COUT ET MODE DE REGLEMENT FORMATION :</span><br/>
...
", "Common\\DocPrint\\Propal\\ConventionContent.html.twig", "/var/www/templates/Common/DocPrint/Propal/ConventionContent.html.twig");
    }
}

...
class __TwigTemplate_dd30969f64771cc870ae2baed6f1c6f8c5d8ca6004b8eb04c151dcd9a13a52ae extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 466
        echo "<script>
    if (document.getElementById('dossier_dateAccord').value == \"\")
    {
        newDate = new Date();
        thisMonth = newDate.getUTCMonth();
        addMonth = 2;

        receptionDate=new Date();
        receptionDate.setUTCMonth(thisMonth + addMonth);
        if((receptionDate.getMonth() + 1 ) < 10)
        {
            month = \"0\" + (receptionDate.getMonth() + 1 );
        }
        else
        {
            month = \"\" + (receptionDate.getMonth() + 1 );
        }
        document.getElementById('dossier_dateAccord').value = \"\" + receptionDate.getDate() + \"/\" + month + \"/\" + receptionDate.getFullYear();
    }
...
";
        // line 498
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["doc_form"]) || array_key_exists("doc_form", $context) ? $context["doc_form"] : (function () { throw new RuntimeError('Variable "doc_form" does not exist.', 498, $this->source); })()), 'form_end', ["render_rest" => false]);
        echo "
...
", "dossier/part/dossier-form.html.twig", "/var/www/templates/dossier/part/dossier-form.html.twig");
    }
}

...
class __TwigTemplate_c024bc2f5fb49ab9636a2fbf4812e763d386363641cfc8ee1c5892bd3fc24f7d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "/home/jeremy/Bureau/project/app/vendor/symfony/framework-bundle/Resources/views/Form/form_label.html.php");
    }
}

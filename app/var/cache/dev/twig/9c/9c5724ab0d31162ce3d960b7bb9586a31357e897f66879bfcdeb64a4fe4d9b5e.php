...
class __TwigTemplate_a7ba39da8477d8d40a079295f0725a3ef1e231ee8d8e0de7e3e412f8e644b16c extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 17
        echo "            <li class=\"breadcrumb-item active\" aria-current=\"page\">Accès interdit</li>
        </ol>
    </nav>

    <h2 class=\"text-center mt-2 text-primary text-danger\"><i class=\"fa fa-ban\" aria-hidden=\"true\"></i> ACCESS INTERDIT</h2>
    <div class=\"row d-flex justify-content-center\">
        <div class=\"col-md-6\">
            <p class=\"alert alert-warning\">
                Vous n'avez pas assez de droit pour accéder à cette page !
                Veuillez consulter l'administrateur du site pour plus d'info.
...
";
    ...
    {
        return array (  110 => 17,  102 => 12,  99 => 11,  97 => 10,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <nav aria-label=\"breadcrumb\">
        <ol class=\"breadcrumb\">
            ...
            {% endif %}
            <li class=\"breadcrumb-item active\" aria-current=\"page\">Accès interdit</li>
        </ol>
    </nav>
...
{% endblock %}
", "@Twig/Exception/error403.html.twig", "/home/jeremy/Bureau/project/app/templates/bundles/TwigBundle/Exception/error403.html.twig");
    }
}

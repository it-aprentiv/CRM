...
class __TwigTemplate_3a27f01a37956f056c946c3175928793b790f5b4f5a710a4b3a98589506e563e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"col-sm-12 p-3 \" id=\"content_bouton\">
    <div class=\"btn-toolbar justify-content-md-center\" role=\"toolbar\" aria-label=\"Toolbar with button groups\">
        ...
        <div class=\"btn-group mr-2 list-filter\" role=\"group\" aria-label=\"Third group\">
                <a href=\"";
            // line 284
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("Liste_Dossiers_Controller/ajoutdossier", ["id_entite" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["propal_form"]) || array_key_exists("propal_form", $context) ? $context["propal_form"] : (function () { throw new RuntimeError('Variable "propal_form" does not exist.', 284, $this->source); })()), "entitypropal", [], "any", false, false, false, 284), "vars", [], "any", false, false, false, 284), "value", [], "any", false, false, false, 284), "id_formation" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["propal"]) || array_key_exists("propal", $context) ? $context["propal"] : (function () { throw new RuntimeError('Variable "propal" does not exist.', 284, $this->source); })()), "formation", [], "any", false, false, false, 284), "id", [], "any", false, false, false, 284), "id_commercial" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["propal_form"]) || array_key_exists("propal_form", $context) ? $context["propal_form"] : (function () { throw new RuntimeError('Variable "propal_form" does not exist.', 284, $this->source); })()), "commercialpropal", [], "any", false, false, false, 284), "vars", [], "any", false, false, false, 284), "value", [], "any", false, false, false, 284), "coutht" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["propal_form"]) || array_key_exists("propal_form", $context) ? $context["propal_form"] : (function () { throw new RuntimeError('Variable "propal_form" does not exist.', 284, $this->source); })()), "coutht", [], "any", false, false, false, 284), "vars", [], "any", false, false, false, 284), "value", [], "any", false, false, false, 284), "clientPropal" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["propal"]) || array_key_exists("propal", $context) ? $context["propal"] : (function () { throw new RuntimeError('Variable "propal" does not exist.', 284, $this->source); })()), "clientpropal", [], "any", false, false, false, 284), "id", [], "any", false, false, false, 284)]), "html", null, true);
...
{{ form_end(propal_form,{'render_rest':false}) }}", "propal/Parts/form.html.twig", "/var/www/templates/propal/Parts/form.html.twig");
    }
}

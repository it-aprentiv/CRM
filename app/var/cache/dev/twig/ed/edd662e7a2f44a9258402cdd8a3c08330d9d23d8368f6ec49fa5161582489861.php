...
/* Common/stagiaire-bloc.html.twig */
class __TwigTemplate_bcc959c627a6e24eae648c943669ecaba5bbed194f1ccebafdcd267769d82fb4 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "Common/stagiaire-bloc.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "Common/stagiaire-bloc.html.twig"));

        // line 1
        echo "
<center>
    <input type=\"button\" class=\"btn btn-warning no-disabled\" style=\"border-radius: 5%;\" id=\"add_stagiaire\" value=\"Ajouter un stagiaire\">
</center>
    ...
    <tbody id=\"stagiaires_collection\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["stagiaire"]) {
            ...
            if ((isset($context["data"]) || array_key_exists("data", $context))) {
                // line 74
                echo "                ";
                if (((isset($context["indexRow"]) || array_key_exists("indexRow", $context) ? $context["indexRow"] : (function () { throw new RuntimeError('Variable "indexRow" does not exist.', 74, $this->source); })()) <= twig_length_filter($this->env, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 74, $this->source); })())))) {
                    // line 75
                    echo "                    ";
                    $context["email"] = twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 75, $this->source); })()), ((isset($context["indexRow"]) || array_key_exists("indexRow", $context) ? $context["indexRow"] : (function () { throw new RuntimeError('Variable "indexRow" does not exist.', 75, $this->source); })()) - 1), [], "array", false, false, false, 75), "email", [], "any", false, false, false, 75);
                    // line 76
                    echo "                ";
                }
                // line 77
...
";
    ...
    public function block_stagiaire_row($context, array $blocks = [])
    {
        ...
        echo "
                ...
                <td class=\"col-sm\">
                    ";
        // line 29
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["prototype"]) || array_key_exists("prototype", $context) ? $context["prototype"] : (function () { throw new RuntimeError('Variable "prototype" does not exist.', 29, $this->source); })()), "Email", [], "any", false, false, false, 29), 'widget', ["attr" => ["value" => (isset($context["email"]) || array_key_exists("email", $context) ? $context["email"] : (function () { throw new RuntimeError('Variable "email" does not exist.', 29, $this->source); })())]]);
        echo "
                    ";
        // line 30
        ...
        echo "\" ";
        if ((isset($context["param_dossier_stagiaire"]) || array_key_exists("param_dossier_stagiaire", $context))) {
            echo "  data-paramDossier =\"";
            echo twig_escape_filter($this->env, (isset($context["param_dossier_stagiaire"]) || array_key_exists("param_dossier_stagiaire", $context) ? $context["param_dossier_stagiaire"] : (function () { throw new RuntimeError('Variable "param_dossier_stagiaire" does not exist.', 46, $this->source); })()), "html", null, true);
            echo "\" ";
        }
        echo ">
    ...
    {
        return "Common/stagiaire-bloc.html.twig";
    }
    ...
    {
        return array (  257 => 46,  250 => 42,  246 => 41,  240 => 38,  236 => 37,  230 => 34,  226 => 33,  220 => 30,  216 => 29,  210 => 26,  206 => 25,  200 => 22,  196 => 21,  191 => 19,  187 => 18,  184 => 17,  181 => 16,  178 => 15,  175 => 14,  172 => 13,  169 => 12,  166 => 11,  163 => 10,  160 => 9,  157 => 8,  147 => 7,  134 => 81,  117 => 79,  114 => 78,  111 => 77,  108 => 76,  105 => 75,  102 => 74,  99 => 73,  96 => 72,  93 => 71,  91 => 70,  73 => 69,  71 => 68,  54 => 53,  52 => 7,  44 => 1,);
    }
    ...
    <thead id=\"stagiaire_prototype\">
        {% block stagiaire_row %}
            ...
            <tr class=\"row\" id=\"stagiaire_row-{{ indexRow }}\">
                ...
                <td class=\"col-sm\">
                    {{ form_widget(prototype.Email, { 'attr': { 'value': email } }) }}
                ...
                <td>
                    <div>
                        <a href=\"javascript:void(0)\" class=\"delete-stagiaire\"  title=\"Supprimer\" style=\"font-size: 140%;\" data-idrow=\"stagiaire_row-{{ indexRow }}\" {% if param_dossier_stagiaire is defined %}  data-paramDossier =\"{{ param_dossier_stagiaire }}\" {% endif %}>
                            <i class=\"fas fa-trash-alt text-danger\"></i>
                        </a>
                    </div>
                </td>
...
", "Common/stagiaire-bloc.html.twig", "/home/jeremy/Bureau/project/app/templates/Common/stagiaire-bloc.html.twig");
    }
}
